...
public class showCartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>\n" +
                ...
                "<a href=\"productList.jsp\" style=\"color: blueviolet;font-size: 30px;display: inline-block\">Back</a>"+
                "<a href=\"logoutServlet\" style=\"color: blueviolet;font-size: 30px;display: inline-block;margin-left:900px\" >Log Out</a></div>"+
